      ...
      <div className="max-w-full mx-auto sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4 dark:text-gray-300">What I've been doing</h2>
            ...
            <div className="flex items-start">
              ...
              <div className="relative mr-4 sm:mr-12 lg:mr-32">
                ...
                <button className="flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left" onClick={() => setYear('2020')}>
                  <span className="block w-12 truncate outline-none">2020</span>
                ...
                <button className="flex items-center justify-between font-medium text-gray-500 dark:text-gray-400 w-20 py-3 pr-2 text-left -z-1" onClick={() => setYear('2019')}>
              ...
              <div className={`flex-grow ${year !== '2016' && 'hidden'}`}>
                <div className="grid md:grid-cols-2 gap-6">
                  <article className="md:col-span-2 p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col rounded-lg">
                    <header>
                      <h3 className="h4 font-red-hat-display mb-1">
                        <a href="#0">Finished Cinema And Television at Maltepe University Istanbul</a>
                      </h3>
                    </header>
                    <div className="text-gray-600 dark:text-gray-400 flex-grow">
                  ...
                  <article className="p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col rounded-lg">
                    <header>
                      <h3 className="h4 font-red-hat-display mb-1">
                        <a href="#0">Started to work as a Video Editor</a>
                      </h3>
                    </header>
                    <div className="text-gray-600 dark:text-gray-400 flex-grow">
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
