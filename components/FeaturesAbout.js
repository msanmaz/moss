...
function FeaturesGallery() {
  return (
    <section>
      <div className="max-w-6xl pt-24 mx-auto px-4 sm:px-6">
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">

          {/* Items */}
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-3 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
                <div className="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-teal-500" aria-hidden="true"></div>
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Landed to Ireland in 2017</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              <div aria-hidden="true" className="absolute h-0.5 bg-gradient-to-r from-white via-gray-300 to-white dark:from-gray-900 dark:via-gray-700 dark:to-gray-900 hidden md:block" style={{ width: 'calc(100% - 96px)', left: 'calc(50% + 64px)', top: '40px' }}></div>
              <div className="relative w-20 h-20 mb-3">
                <div className="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-purple-500" aria-hidden="true"></div>
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Started at Griffith College</div>
            </div>

            {/* 3rd item */}
            <div className="relative flex flex-col items-center">
              <div className="relative w-20 h-20 mb-3">
                <div className="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-indigo-500" aria-hidden="true"></div>
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Completed Reactjs Course</div>
            </div>
