...
function Header() {
  ...
  useEffect(() => {
    ...
    // detect whether user has scrolled the page down by 50px 
    useEffect(() => {
        const scrollHandler = () => {
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:flex-grow justify-end">
            ...
            <ul className="flex justify-end flex-wrap items-center">
              <li className="btn-sm text-white bg-teal-500 hover:bg-teal-400 ml-6">
            ...
            <div className="form-switch focus-within:outline-blue flex flex-col justify-center ml-3">
              <input type="checkbox" name="light-switch" id="light-switch-desktop" className="light-switch sr-only" checked={colorTheme} onClick={() => setTheme(colorTheme)}/>
          ...
          <div className="inline-flex md:hidden">
            ...
            <div className="form-switch focus-within:outline-blue flex flex-col justify-center mr-6 -mt-0.5">
              <input type="checkbox" name="light-switch" id="light-switch-mobile" className="light-switch sr-only" checked={colorTheme} onChange={() => setTheme(colorTheme)}/>
            ...
            {/* Hamburger button */}
            <button className={`hamburger ${mobileNavOpen && 'active'}`} aria-controls="mobile-nav" aria-expanded={mobileNavOpen} onChange={() => setMobileNavOpen(!mobileNavOpen)}>
            ...
            >
              <nav id="mobile-nav" ref={mobileNav} className="fixed top-0 h-screen z-20 left-0 w-full max-w-sm -ml-16 overflow-scroll bg-white dark:bg-gray-900 shadow-lg">
                <div className="py-6 pr-4 pl-20">                  
                  ...
                  <ul>
                    <li>
                      <Link href="/about" className="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">About</Link>
                    </li>
                    <li>
                      <Link href="/blog" className="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">Blog</Link>
                    </li>
                    <li>
                      <Link href="/testimonials" className="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">Testimonials</Link>
                    </li>
                    <li className="py-2 my-2 border-t border-b border-gray-200 dark:border-gray-800">
                      ...
                      <ul className="pl-4">
                        <li>
                          <Link href="/help" className="text-sm flex font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 py-2">Help center</Link>
                        </li>
                        <li>
                          <Link href="/404" className="text-sm flex font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 py-2">404</Link>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <Link href="/contact" className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded text-white bg-teal-500 hover:bg-teal-400 transition duration-150 ease-in-out">Request code</Link>
                    </li>
                  </ul>
                </div>
              </nav>
